...
\end{align*}
and similarly for $Q_t$.  Instantaneous income\footnote{A more formal treatment of how to relate this to the log income process is given in appendix \ref{log_tranformation}} in a period $dt$ is given by:
\begin{align}
